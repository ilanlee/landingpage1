...
<heder class="flex flex-col relative z-20">
    <div class="max-w-[1400px] mx-auto w-full flex items-center justify-between p-4 py-6">
        <a href="/">
            <h1 class="font-semibold">Swoley <span class="text-indigo-400">Moley</h1>
        </a>
        ...
        <nav class="hidden md:flex items-center gap-4 lg:gap-6">
            ...
            <a href="#review" class="duration-200 hover:text-indigo-400 cursor-pointer">Reviews</a>
